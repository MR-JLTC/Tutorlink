                    ...
                    >
                        <div className="space-y-4">
                            <div className="text-sm text-slate-700">
                                ...
                                <p><strong>Status:</strong> <span className={`px-2 py-0.5 text-xs font-semibold rounded-full ${statusColors[selectedProofModalPayment.status]}`}>
