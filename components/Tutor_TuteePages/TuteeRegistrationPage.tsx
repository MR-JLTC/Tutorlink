        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="number" id="yearLevel" name="yearLevel" placeholder="e.g., 3" min="1" max="8" value={formData.yearLevel} onChange={handleInputChange} className="w-full px-4 py-2 border border-slate-300 rounded-lg" required />
            </div>
          </div>
