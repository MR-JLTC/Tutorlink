        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div>
              ...
              {/* 1. Added 'w-full' to make the container match the input width. */}
              <div className="relative w-full">
                <input 
                  ...
                  required 
                  className="
                    w-full py-2 pl-4 pr-12 border border-slate-300 
                    rounded-lg [&::-webkit-credentials-auto-fill-button]:!hidden 
                    [&::-ms-reveal]:hidden 
