...
interface ChangePasswordVerificationProps {
  onBack: () => void;
}

const ChangePasswordVerification: React.FC<ChangePasswordVerificationProps> = ({ onBack }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.post('/auth/change-password/verify-and-change', {
        code: formData.code,
